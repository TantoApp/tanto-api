...
# apibuilder 0.14.59 app.apibuilder.io/tantoapp/project/1.0.0-dev/ruby_client
    ...
    module V1
      ...
      class Client
        ...
        module Constants
          ...
          NAMESPACE = 'tantoapp.project.v1' unless defined?(Constants::NAMESPACE)
          USER_AGENT = 'apibuilder 0.14.59 app.apibuilder.io/tantoapp/project/1.0.0-dev/ruby_client' unless defined?(Constants::USER_AGENT)
        ...
        def projects
          @projects ||= ::Tantoapp::Project::V1::Clients::Projects.new(self)
        end
      end
      ...
      module Clients
        ...
        class Projects
          ...
          def initialize(client)
            @client = HttpClient::Preconditions.assert_class('client', client, ::Tantoapp::Project::V1::Client)
          end
          ...
          def get_by_id(id)
            ...
            r = @client.request("/api/v1/projects/#{id}").get
            ::Tantoapp::Project::V1::Models::Project.new(r)
          end

          def post(project_form)
            (x = project_form; x.is_a?(::Tantoapp::Project::V1::Models::ProjectForm) ? x : ::Tantoapp::Project::V1::Models::ProjectForm.new(x))
            r = @client.request("/api/v1/projects").with_json(project_form.to_json).post
            ::Tantoapp::Project::V1::Models::Project.new(r)
          end

          # Deletes the project specified via id
          def delete_by_id(id)
            HttpClient::Preconditions.assert_class('id', id, Integer)
            r = @client.request("/api/v1/projects/#{id}").delete
            r
          end

          # Updates the project specified via id
          def put_by_id(id, project_form)
            HttpClient::Preconditions.assert_class('id', id, Integer)
            (x = project_form; x.is_a?(::Tantoapp::Project::V1::Models::ProjectForm) ? x : ::Tantoapp::Project::V1::Models::ProjectForm.new(x))
            r = @client.request("/api/v1/projects/#{id}").with_json(project_form.to_json).put
            ::Tantoapp::Project::V1::Models::Project.new(r)
          end
      ...
      module Models
        ...
        class Project
          ...
          def copy(incoming={})
            Project.new(to_hash.merge(HttpClient::Helper.symbolize_keys(incoming)))
          end
        ...
        class ProjectForm
          ...
          attr_reader :name, :description, :status, :active

          def initialize(incoming={})
            opts = HttpClient::Helper.symbolize_keys(incoming)
            HttpClient::Preconditions.require_keys(opts, [:name, :description], 'ProjectForm')
            @name = HttpClient::Preconditions.assert_class('name', opts.delete(:name), String)
            @description = HttpClient::Preconditions.assert_class('description', opts.delete(:description), String)
          ...
          def copy(incoming={})
            ProjectForm.new(to_hash.merge(HttpClient::Helper.symbolize_keys(incoming)))
          end
