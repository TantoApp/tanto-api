...
# apibuilder 0.14.59 app.apibuilder.io/tantoapp/test/1.0.0-dev/ruby_client
    ...
    module V1
      ...
      class Client
        ...
        module Constants
          ...
          NAMESPACE = 'tantoapp.test.v1' unless defined?(Constants::NAMESPACE)
          USER_AGENT = 'apibuilder 0.14.59 app.apibuilder.io/tantoapp/test/1.0.0-dev/ruby_client' unless defined?(Constants::USER_AGENT)
        ...
        def tests
          @tests ||= ::Tantoapp::Test::V1::Clients::Tests.new(self)
        end
      end
      ...
      module Clients
        ...
        class Tests
          ...
          def initialize(client)
            @client = HttpClient::Preconditions.assert_class('client', client, ::Tantoapp::Test::V1::Client)
          end
          ...
          def get_by_id(id)
            ...
            r = @client.request("/api/v1/tests/#{id}").get
            ::Tantoapp::Test::V1::Models::Test.new(r)
          end

          def post(test_form)
            (x = test_form; x.is_a?(::Tantoapp::Test::V1::Models::TestForm) ? x : ::Tantoapp::Test::V1::Models::TestForm.new(x))
            r = @client.request("/api/v1/tests").with_json(test_form.to_json).post
            ::Tantoapp::Test::V1::Models::Test.new(r)
          end

          # Deletes the test specified via id
          def delete_by_id(id)
            HttpClient::Preconditions.assert_class('id', id, Integer)
            r = @client.request("/api/v1/tests/#{id}").delete
            r
          end

          # Updates the test specified via id
          def put_by_id(id, test_form)
            HttpClient::Preconditions.assert_class('id', id, Integer)
            (x = test_form; x.is_a?(::Tantoapp::Test::V1::Models::TestForm) ? x : ::Tantoapp::Test::V1::Models::TestForm.new(x))
            r = @client.request("/api/v1/tests/#{id}").with_json(test_form.to_json).put
            ::Tantoapp::Test::V1::Models::Test.new(r)
          end
      ...
      module Models
        ...
        class TestForm
          ...
          attr_reader :test_case_id, :description, :status, :active

          def initialize(incoming={})
            opts = HttpClient::Helper.symbolize_keys(incoming)
            HttpClient::Preconditions.require_keys(opts, [:test_case_id, :description], 'TestForm')
            @test_case_id = HttpClient::Preconditions.assert_class('test_case_id', opts.delete(:test_case_id), Integer)
            @description = HttpClient::Preconditions.assert_class('description', opts.delete(:description), String)
          ...
          def copy(incoming={})
            TestForm.new(to_hash.merge(HttpClient::Helper.symbolize_keys(incoming)))
          end
