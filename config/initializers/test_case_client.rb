...
# apibuilder 0.14.59 app.apibuilder.io/tantoapp/test_case/1.0.0-dev/ruby_client
      ...
      module V1
        ...
        class Client
          ...
          module Constants
            ...
            NAMESPACE = 'tantoapp.test.case.v1' unless defined?(Constants::NAMESPACE)
            USER_AGENT = 'apibuilder 0.14.59 app.apibuilder.io/tantoapp/test_case/1.0.0-dev/ruby_client' unless defined?(Constants::USER_AGENT)
          ...
          def test_cases
            @test_cases ||= ::Tantoapp::Test::Case::V1::Clients::TestCases.new(self)
          end
        end
        ...
        module Clients
          ...
          class TestCases
            ...
            def initialize(client)
              @client = HttpClient::Preconditions.assert_class('client', client, ::Tantoapp::Test::Case::V1::Client)
            end
            ...
            def get_by_id(id)
              ...
              r = @client.request("/api/v1/test_cases/#{id}").get
              ::Tantoapp::Test::Case::V1::Models::TestCase.new(r)
            end

            def post(test_case_form)
              (x = test_case_form; x.is_a?(::Tantoapp::Test::Case::V1::Models::TestCaseForm) ? x : ::Tantoapp::Test::Case::V1::Models::TestCaseForm.new(x))
              r = @client.request("/api/v1/test_cases").with_json(test_case_form.to_json).post
              ::Tantoapp::Test::Case::V1::Models::TestCase.new(r)
            end

            # Deletes the test_case specified via id
            def delete_by_id(id)
              HttpClient::Preconditions.assert_class('id', id, Integer)
              r = @client.request("/api/v1/test_cases/#{id}").delete
              r
            end

            # Updates the test_case specified via id
            def put_by_id(id, test_case_form)
              HttpClient::Preconditions.assert_class('id', id, Integer)
              (x = test_case_form; x.is_a?(::Tantoapp::Test::Case::V1::Models::TestCaseForm) ? x : ::Tantoapp::Test::Case::V1::Models::TestCaseForm.new(x))
              r = @client.request("/api/v1/test_cases/#{id}").with_json(test_case_form.to_json).put
              ::Tantoapp::Test::Case::V1::Models::TestCase.new(r)
            end
        ...
        module Models
          ...
          class TestCase
            ...
            def copy(incoming={})
              TestCase.new(to_hash.merge(HttpClient::Helper.symbolize_keys(incoming)))
            end
          ...
          class TestCaseForm
            ...
            attr_reader :project_id, :description, :status, :active

            def initialize(incoming={})
              opts = HttpClient::Helper.symbolize_keys(incoming)
              HttpClient::Preconditions.require_keys(opts, [:project_id, :description], 'TestCaseForm')
              @project_id = HttpClient::Preconditions.assert_class('project_id', opts.delete(:project_id), Integer)
              @description = HttpClient::Preconditions.assert_class('description', opts.delete(:description), String)
            ...
            def copy(incoming={})
              TestCaseForm.new(to_hash.merge(HttpClient::Helper.symbolize_keys(incoming)))
            end
